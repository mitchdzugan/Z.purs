module Z.Z.Lens.Barlow.Construction where
...
import Z.Z.Lens.Barlow.Generic (_Argument, _Constructor, _NoArguments, _ProductLeft, _ProductRight, _SumLeft, _SumRight, _ToGeneric)
import Z.Z.Lens.Barlow.Types (ExclamationMark, LeftArrow, N1, Percentage, Plus, QuestionMark, RecordField, RightArrow, S, TCons, TList, TNil)
...
class
  ConstructBarlowGeneric (lenses :: TList) p s t a b
  | lenses s -> t a b where
...
instance
  ...
  ConstructBarlowGeneric
    ...
    a
    a where
  constructBarlowGeneric _ = _Constructor <<< _Argument <<< constructBarlow
    (Proxy :: Proxy rest)
else instance
  ...
  ConstructBarlowGeneric
    ...
    a
    a where
  constructBarlowGeneric _ = _Constructor <<< constructBarlowGeneric
    (Proxy :: Proxy rest)
--------- PERCENTAGE LEFT SUM -----------------------
else instance
  ( Choice p
  ...
  ConstructBarlowGeneric
    ...
    a where
  constructBarlowGeneric _ = _SumLeft <<< _Constructor <<< _Argument <<<
    constructBarlow (Proxy :: Proxy rest)
else instance
  ( ConstructBarlowGeneric rest p restA restA a a
  , Choice p
  ) =>
  ConstructBarlowGeneric
    ...
    a
    a where
  constructBarlowGeneric _ = _SumLeft <<< _Constructor <<<
    constructBarlowGeneric (Proxy :: Proxy rest)
--------- PERCENTAGE RIGHT SUM -----------------------
  ...
  ConstructBarlowGeneric
    ...
    a
    a where
  constructBarlowGeneric _ = _SumRight <<< constructBarlowGeneric
    (Proxy :: Proxy (TCons (Percentage sym) rest))
--------- PERCENTAGE LEFT PRODUCT -----------------------
  ...
  ConstructBarlowGeneric
    ...
    a
    a where
  constructBarlowGeneric _ = _ProductLeft <<< _Argument <<< constructBarlow
    (Proxy :: Proxy rest)
--------- PERCENTAGE RIGHT PRODUCT -----------------------
  ...
  ConstructBarlowGeneric
    ...
    a
    a where
  constructBarlowGeneric _ = _ProductRight <<< constructBarlowGeneric
    (Proxy :: Proxy (TCons (Percentage k) rest))
...
-- Cons instance for record selector
  ...
  constructBarlow _ = prop (Proxy :: Proxy sym) <<< constructBarlow
    (Proxy :: Proxy rest)
-- Instance for generic
  ...
  ConstructBarlow
    ...
    a
    a where
  constructBarlow _ = _ToGeneric <<< constructBarlowGeneric
    (Proxy :: Proxy tlist)
